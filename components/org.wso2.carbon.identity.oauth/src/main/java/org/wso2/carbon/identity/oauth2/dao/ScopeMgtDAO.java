...
public class ScopeMgtDAO {
     ...
     */
    public void addScope(ScopeDO scope, int tenantID) throws IdentityOAuth2Exception {
     ...
     * @throws IdentityOAuth2Exception
     */
    public Set<ScopeDO> getAllScopes(int tenantID) throws IdentityOAuth2Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ScopeDO scopeDO = new ScopeDO(rs.getString(1), rs.getString(2), rs.getString(3),
     ...
     * @throws IdentityOAuth2Exception
     */
    public Set<ScopeDO> getScopesWithPagination(Integer offset, Integer limit, int tenantID) throws IdentityOAuth2Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ScopeDO scopeDO = new ScopeDO(rs.getString(1), rs.getString(2), rs.getString(3), null);
                scopes.add(scopeDO);
            }

            for(ScopeDO scopeDO : scopes) {
                List<String> bindings = new ArrayList<>();
                preparedStatement = conn.prepareStatement(SQLQueries.RETRIEVE_SCOPE_BINDINGS);
                preparedStatement.setString(1, scopeDO.getId());
                rs = preparedStatement.executeQuery();
                while (rs.next()) {
                    bindings.add(rs.getString(1));
                }
                scopeDO.setBindings(bindings);
            }
            return scopes;
        } catch (SQLException e) {
            try {
     ...
     * @throws IdentityOAuth2Exception
     */
    public Set<ScopeDO> getScopesWithPaginationAndFilter(String attributeName, String attributeValue, Integer offset, Integer limit, int tenantID)
            throws IdentityOAuth2Exception {
     ...
     * @throws IdentityOAuth2Exception
     */
    public ScopeDO getScopeByID(String scopeID, int tenantID) throws IdentityOAuth2Exception {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                scope = new ScopeDO(scopeID, scopeName, description, bindings);
            }
            return scope;
        } catch (SQLException e) {
            try {
     ...
     * @throws IdentityOAuth2Exception
     */
    public void updateScopeByID(String scopeID, ScopeDO updatedScope, int tenantID) throws IdentityOAuth2Exception {
